...
describe("formatDates", () => {
  ...
  test.only("should be able to update the created_at without changing anything else", () => {
    ...
    console.log(expectedOutput[0].created_at);
    expect(expectedOutput).not.toBe(input);
    ...
    const expectedOutput = [
      {
        ...
        author: "butter_bridge",
        votes: 16,
        created_at: "2017-011-022T12:36:3.389Z",
      },
    ];
    expect(actualOutput).toEqual(expectedOutput);
  });
